...
class GPT2ModelPipe(PipelineModule, torch.nn.Module):
    ...
    def to_sequential(self):
        ...
        ## my: This func will not be run when neox_args.is_pipe_parallel=True. For Pythia: neox_args.is_pipe_parallel=True. Please check the training.py file to understand. 
        ...
        return model
    def forward(self, forward_input):   ##my adding: We add this forward funtion to override the original forward function of PipelineModule. 
        """
